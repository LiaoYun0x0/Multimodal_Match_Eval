...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(
        RotateRocketDataset("/media/ly/data/rockets/rockets_subject3_data/rockets/stage/test/test1.txt",size=size),
        batch_size=4,
        shuffle=True,
        num_workers=0,
        pin_memory=True)
    ...
    while 1:
        for sample in dataloader:
            ...
            cv2.imshow(f"images/match_img0{num}.jpg",out0)
            cv2.imshow(f"images/match_img1{num}.jpg",out1)
            cv2.waitKey()
